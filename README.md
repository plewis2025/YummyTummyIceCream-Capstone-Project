...
- Interact with a colorful, emoji-enhanced console menu

---

  Screenshots

> *(Add screenshots here once captured — use IntelliJ or terminal images showing the menu, sandwich summary, and order total)*
